...
from keras.layers import Dense, Dropout, Flatten, Lambda, ELU,Conv2D,LSTM, MaxPooling2D, Input
...
def inceptionv3(width, height, frame_count, lr, output=40, model_name = 'default.model'):
